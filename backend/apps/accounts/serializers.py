...
class ActivityItemSerializer(serializers.Serializer):
    """
    Enhanced serializer for activity feed items.
    Supports multiple activity types: visits, reviews, follows.
    """
    ...
    actor_username = serializers.CharField(allow_null=True, required=False)
    actor_display_name = serializers.CharField(allow_null=True, required=False)
    actor_avatar_url = serializers.URLField(allow_null=True, required=False)

    # Target (for follows)
    target_username = serializers.CharField(allow_null=True, required=False)
    target_display_name = serializers.CharField(allow_null=True, required=False)
    target_avatar_url = serializers.URLField(allow_null=True, required=False)

    # Cafe (for cafe activities)
    cafe_id = serializers.IntegerField(allow_null=True, required=False)
    cafe_name = serializers.CharField(allow_null=True, required=False)
    cafe_google_place_id = serializers.CharField(allow_null=True, required=False)

    # Activity details
    wfc_rating = serializers.IntegerField(allow_null=True, required=False)
    comment = serializers.CharField(allow_null=True, required=False)
    visit_time = serializers.IntegerField(allow_null=True, required=False)
    amount_spent = serializers.DecimalField(max_digits=10, decimal_places=2, allow_null=True, required=False)
